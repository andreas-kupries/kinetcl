...
critcl::tsources policy_base.tcl

critcl::tsources policy_generator.tcl ; # -> base
...
critcl::tsources policy_map.tcl       ; # -> generator -> base
...
critcl::source kt_context.tcl   ; # Package per-interp information.

critcl::source kt_base.tcl      ; # 
critcl::source kt_generator.tcl ; # -> base
critcl::source kt_map.tcl       ; # -> generator -> base
